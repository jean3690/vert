      ...
      messages: [
        {
          role: "system",
          content: [
            `Translate Vert UI i18n strings from Simplified Chinese to ${TARGET_LABELS[locale]}.`,
            ...
            "Keep product names, file format names, file extensions, shortcuts, and code-like terms unchanged unless the target language convention clearly translates them.",
